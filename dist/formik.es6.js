...
var Formik = (function (_super) {
    ...
    function Formik(props) {
        ...
        _this.runValidationSchema = function (values, callback) {
            ...
            validateYupSchema(values, schema).then(function () {
                ...
                _this.setState({ errors: yupToFormErrors(err), isSubmitting: false });
                if (callback) {
                    callback(err);
                }
            });
        ...
        _this.submitForm = function () {
            ...
            if (_this.props.validate) {
                ...
                if (isPromise(maybePromisedErrors)) {
                    return maybePromisedErrors.then(function () {
                        _this.setState({ errors: {} });
                        return _this.executeSubmit();
                    }, function (errors) {
                        _this.setState({ errors: errors, isSubmitting: false });
                ...
                return new Promise(function (resolve, reject) {
                    _this.runValidationSchema(_this.state.values, function (err) {
                        if (err) {
                            reject(err);
                        }
                        else {
                            resolve(_this.executeSubmit());
                        }
                    });
                });
            }
        ...
        _this.executeSubmit = function () {
            return Promise.resolve(_this.props.onSubmit(_this.state.values, _this.getFormikActions()));
        };
        ...
        _this.resetForm = function (nextValues) {
            ...
            Object.keys(_this.fields).map(function (f) { return _this.fields[f](); });
        };
    ...
    Formik.prototype.getChildContext = function () {
        return {
            formik: __assign({}, this.getFormikBag(), { validationSchema: this.props.validationSchema, validate: this.props.validate }),
        };
    };
...
function validateYupSchema(data, schema, sync, context) {
